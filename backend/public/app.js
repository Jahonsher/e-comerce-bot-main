...
const translations = {
  uz: {
    ...
    "product.notfound":     "Hozircha hechnarsa qo'shilmagan",
    ...
    "footer.desc":          "Aqso Tour – sizning orzudagi sayohatlaringizni amalga oshirish uchun ishonchli hamkoringiz. Eng yaxshi yo'nalishlar, qulay narxlar va unutilmas tajribalar sizni kutmoqda!",
    ...
    "gallery.subtitle":     "\"Galereyamizda sayohat mo'jizalarini oching, Aqso Tour sarguzashtlaridan lavha.\"",
  ...
  ru: {
    ...
    "product.notfound":     "Пока ничего не добавлено",
    ...
    "footer.desc":          "Aqso Tour – ваш надёжный партнёр для осуществления путешествий мечты. Лучшие направления, доступные цены и незабываемые впечатления ждут вас!",
    ...
    "gallery.subtitle":     "\"Откройте чудеса путешествий в нашей галерее, кадры из приключений Aqso Tour.\"",
